  ...
  return (
    <div style={{display:'flex',minHeight:'100vh',fontFamily:'Inter,system-ui,sans-serif',background:'#f8fafc'}}>
      ...
      <div style={{borderTop:'1px solid #e2e8f0',padding:'14px 28px',display:'flex',alignItems:'center',justifyContent:'space-between',background:'#fff',marginTop:'auto'}}>
        <span style={{fontSize:11,color:'#94a3b8'}}>© 2026 Zenvoy</span>
        <div style={{display:'flex',gap:20}}>
          <a href="https://zenvoy.app/privacy" style={{fontSize:11,color:'#94a3b8',textDecoration:'none'}} target="_blank" rel="noreferrer">Privacy</a>
          <a href="https://zenvoy.app/terms" style={{fontSize:11,color:'#94a3b8',textDecoration:'none'}} target="_blank" rel="noreferrer">Terms</a>
          <a href="https://zenvoy.app/support" style={{fontSize:11,color:'#94a3b8',textDecoration:'none'}} target="_blank" rel="noreferrer">Support</a>
        </div>
      </div>
    </div>
  )
